...
# encoding: UTF-8
#
# GPL; Boris Köster, x-itec@freenet.de, http://www.x-itec.net
...
class PassGenerator < ::Escort::ActionCommand::Base
  ...
  def execute
    ...
    key = OpenSSL::PKCS5.pbkdf2_hmac_sha1(command_options.password.reverse, command_options.salt.reverse, command_options.rounds, size)
...
Escort::App.create do |app|
  ...
  app.description "
This is an internal tool to protect services and passwords at X-itec. You enter your name-password and a service and you get a public password. Most people use the same password for everything - you can still do this, but with this tool you get different passwords for every service you want AND the password is very well designed.
...
This tool is no toy - its a really important utility.
  ...
  Result: 5aK6aVOn3dbzXmgOiHiTH7 (this is a new password scrambled more than 200.000 times)
  ...
  With the -x option, you create a very long and strong password based on your simple password.
...


  This is the pass that an attacker needs to figure out if you use it for encryption.

  Now let's encrypt a file with this very long password	

  openssl enc -aes-256-cbc -a -salt -in infile.txt -out outfile.enc -pass pass:`xpg genpass --pass 'mysecretpassword' --service 'openssl-aes' -x`

  The attacker cannot decrypt the file with  'mysecretpassword' he needs this tool AND your correct pass + service-name.

    Let's test the decryption without the tool to figure out if it works.

  openssl enc -d -aes-256-cbc -a -in outfile.enc -pass pass: -out decrypted.txt
